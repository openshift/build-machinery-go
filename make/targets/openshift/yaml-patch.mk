...
ifeq "" "$(wildcard $(YAML_PATCH))"
	...
	# TODO: move this repo into the openshift org
	curl -s -f -L https://github.com/therealjon/yaml-patch/releases/download/$(YAML_PATCH_VERSION)/yaml_patch_$(GOHOSTOS)_$(GOHOSTARCH) -o '$(YAML_PATCH)'
	chmod +x '$(YAML_PATCH)';
else
